...
class AudioAttentionExtractor(AttentionExtractor):
    ...
    def __init__(self, audio_model: AudioModel):
        ...
        if self.model_metadata.align_to_text_tokens:
            self.audio_text_attentions_matcher = AudioTextAttentionsMatcher(text_model_name=self.model_metadata.aligner_tokenizer_name)
    ...
    def align_attentions(self, sample: Sample, attention: Attentions, use_cls_and_sep: bool):
        ...
        assert self.model_metadata.align_to_text_tokens, "Need to ask for align"
